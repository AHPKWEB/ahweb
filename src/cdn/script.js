...
return inputsValid}}
var validCoupons={'DISCOUNT10':10,'DISCOUNT20':20,'DISCOUNT30':30};var couponDiscount=0;function applyCoupon(){var couponCode=$('#coupon_code').val();if(validCoupons[couponCode]){couponDiscount=validCoupons[couponCode];alert('Coupon applied: '+couponDiscount+'% off')}else{couponDiscount=0;alert('Invalid coupon code')}
getPrice()}
...
vat_rate=(p*vat/100).toFixed(2);document.getElementById("price").innerHTML='AED '+p;document.getElementById("vat_place").innerHTML='AED '+vat_rate;document.getElementById("total_price").innerHTML='AED '+(parseFloat(p)+parseFloat(vat_rate)).toFixed(2);document.getElementById("total2_price").innerHTML='AED '+(parseFloat(p)+parseFloat(vat_rate)).toFixed(2);document.getElementById("total3_price").innerHTML='AED '+(parseFloat(p)+parseFloat(vat_rate)).toFixed(2);$(".total_price").text('Total: AED '+(parseFloat(p)+parseFloat(vat_rate)).toFixed(2));document.getElementById("discount_place").innerHTML='Discount: AED '+discountAmount;document.getElementById("amount").value=p;document.getElementById("amount_vat").value=vat_rate;document.getElementById("amount_total").value=(parseFloat(p)+parseFloat(vat_rate)).toFixed(2)}
